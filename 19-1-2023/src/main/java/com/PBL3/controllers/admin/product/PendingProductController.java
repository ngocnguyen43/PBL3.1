...
@WebServlet(urlPatterns = {EndPoint.V1 + EndPoint.PRIVATE + "/products/pending"})
public class PendingProductController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        ErrorHandler.handle(resp, () -> iProductService.getAllPending(dto));
    }

    @Override
    protected void doPut(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ErrorHandler.handle(resp, () -> iProductService.activeProducts(req.getParameter("id")));
    }
}
