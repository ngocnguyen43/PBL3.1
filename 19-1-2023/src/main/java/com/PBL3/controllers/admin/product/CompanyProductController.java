...
@WebServlet(urlPatterns = {EndPoint.V1 + EndPoint.COMPANY + "/product"})
@MultipartConfig
public class CompanyProductController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ErrorHandler.handle(resp, () -> iProductService.getProduct(req.getParameter("id"), req.getHeader("client_id")));
    }
}
